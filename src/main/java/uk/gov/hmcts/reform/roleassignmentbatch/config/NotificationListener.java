...
public class NotificationListener extends StepExecutionListenerSupport {
    ...
    public ExitStatus afterStep(StepExecution stepExecution) {
        ...
        log.info("!!! Current JOB FINISHED with status {}! Time to verify the results", stepExecution.getStatus());
        ...
        if (integer > 0 || totalCountFromCcdView != totalCountFromRoleAssignment) {
            ...
            log.info("CCD Migration job is failed. Please check Audit_Fault and reconciliation_data table(s)");
