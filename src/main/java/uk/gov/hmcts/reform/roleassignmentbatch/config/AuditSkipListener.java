...
public class AuditSkipListener implements SkipListener<CcdCaseUsers, EntityWrapper> {
    ...
    @SneakyThrows
    @Override
    public void onSkipInProcess(CcdCaseUsers item, Throwable t) {
    ...
    public void onSkipInWrite(EntityWrapper item, Throwable t) {
        ...
        auditFaults.setCcdUsers(getJson(item.getCcdCaseUsers()));
