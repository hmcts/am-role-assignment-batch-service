...
public class TestDataBuilder {
    ...
    public static CcdCaseUsers buildCcdCaseUsers() {
        UUID requestUuid = UUID.randomUUID();
        CcdCaseUsers ccdCaseUsers = new CcdCaseUsers();
        ccdCaseUsers.setUserId(requestUuid.toString());
        ccdCaseUsers.setCaseRole("Role");
        ccdCaseUsers.setCaseType("type");
        ccdCaseUsers.setCaseDataId("DataId");
        return ccdCaseUsers;
    }
}